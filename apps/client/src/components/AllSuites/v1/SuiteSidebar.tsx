...
const Links = [
  { href: "/interviewer-dashboard", label: "Home", icon: House },
  {
    href: "/interviewer-dashboard/interview-suite",
    label: "Suites",
    icon: FolderKanban,
  },
  {
    href: "/interviewer-dashboard/job-listing",
    label: "Post Jobs",
    icon: BriefcaseBusiness,
  },
  {
    href: "/interviewer-dashboard/wishlist",
    label: "WishList",
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex flex-1 items-center justify-between">
                      ...
                      <span
                        className={`text-xs ${active ? "text-black/60" : "text-white/35"}`}
                      >
