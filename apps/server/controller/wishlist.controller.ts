...
class WishlistController {
  async createWishlist(req: Request, res: Response) {
    try {
      ...
      return res
        .status(200)
        .json(
          apiResponse(200, "Wishlist Created Successfully", createdWishlist),
        );
    } catch (error: any) {
      return res
        .status(200)
  ...
  async updateWishlist(req: Request, res: Response) {
    try {
      ...
      return res
        .status(200)
        .json(
          apiResponse(200, "Wishlist Updated Successfully", updatedWishlist),
        );
    } catch (error: any) {
      return res
        .status(200)
  ...
  async deleteWishlist(req: Request, res: Response) {
    try {
      ...
      return res
        .status(200)
        .json(
          apiResponse(200, "Wishlist Deleted Successfully", deletedWishlist),
        );
    } catch (error: any) {
      return res
        .status(200)
  ...
  async getWishlistById(req: Request, res: Response) {
    try {
      ...
      const wishlistCacheKey = getWishlistDetailCacheKey(
        userId,
      ...
      return res
        .status(200)
        .json(apiResponse(200, "Wishlist Fetched Successfully", existingList));
    } catch (error: any) {
      return res
        .status(200)
        .json(apiResponse(error.statusCode, error.message, null));
  ...
  async getAllWishlistByUser(req: Request, res: Response) {
    try {
      ...
      return res
        .status(200)
        .json(apiResponse(200, "All wishlist by user fetched", allWishlists));
    } catch (error: any) {
      return res
        .status(200)
        .json(apiResponse(error.statusCode, error.message, null));
